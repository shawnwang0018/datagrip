#过仓
SELECT DATE_FORMAT(a.CREATE_TIME, '%Y-%c-%d %H%i') 过仓, COUNT(1)
FROM t_send_wms a
WHERE a.SHOP_ID NOT IN (
  ...
  AND a.CREATE_TIME > '2020-6-16 00:00:00'
  AND a.MSG_TYPE = 'SO'
...
WHERE a.SHOP_ID IN (
  ...
  AND a.MSG_TYPE = 'SO'
  AND a.KEY_CODE = s.PLATFORM_ORDER_CODE_N
