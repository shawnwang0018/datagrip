...
SELECT * FROM t_wf_workflow_transition  t WHERE t.CODE = 'WAIT_CMD_TO_WH';


SELECT * FROM t_wf_workflow_action_reg t WHERE t.WORKFLOW_TRANSITION_ID IN (123,143,175,108375);
